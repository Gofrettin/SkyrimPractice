...
void hBuildHacks(IDirect3DDevice9* pDevice)
{
	...
	if (hMenuItem[3])
	{
		...
		hMenu->DrawTextShadow((CHAR*)("Radar - Player: " + AddrToHexString(LocalPlayerPtr)).c_str(), radarDimensions[0] + 2, radarDimensions[1] - (3 + titleBarOffset), D3DCOLOR_RGBA(255, 255, 255, 255), pFont);//Title Text
